...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Produto p4 = new Produto(null, "Blusa", 19.30);
		Produto p5 = new Produto(null, "Rodo", 27.00);
		Produto p6 = new Produto(null, "Lampada", 92.00);
		Produto p7 = new Produto(null, "Mesa de Escritório", 300.00);
		Produto p8 = new Produto(null, "Roçadeira", 2000.00);
		Produto p9 = new Produto(null, "Abajour", 100.00);
		Produto p10 = new Produto(null, "Impressora", 180.00);
		Produto p11 = new Produto(null, "tv True color", 80.00);
		...
		Cidade cd1 = new Cidade(null, "Uberlândia", uf1);
		Cidade cd2 = new Cidade(null, "São Paulo", uf2);
		Cidade cd3 = new Cidade(null, "Campinas", uf2);

		uf1.getCidades().addAll(Arrays.asList(cd1));
		uf2.getCidades().addAll(Arrays.asList(cd2, cd3));

		estadoRepository.saveAll(Arrays.asList(uf1, uf2));
		cidadeRepository.saveAll(Arrays.asList(cd1, cd2, cd3));

		Cliente cliente = new Cliente(null, "Fabricio", "fabricio.jacob@outlook.com", "33967386830",
				TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("batata"));
		Cliente cliente2 = new Cliente(null, "Ana Costa", "anacosta@outlook.com", "9963323655",
				TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("batata"));
		cliente2.addPerfil(Perfil.ADMIN);

		cliente.getTelefones().addAll(Arrays.asList("988486226", "9880804222"));
		cliente2.getTelefones().addAll(Arrays.asList("988088842", "39877118"));

		Endereco e1 = new Endereco(null, "Rua flores", "300", "apt 103", "Jardim", "38220834", cliente, cd1);
		Endereco e2 = new Endereco(null, "Av Matos", "105", "Sala 8700", "Centro", "215555", cliente, cd2);
		Endereco e3 = new Endereco(null, "Av Floriano", "206", null, "Centro", "14150000", cliente2, cd2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 19:30"), cliente, e2);
		...
		ItemPedido item2 = new ItemPedido(ped1, p2, 0.00, 2, 80.00);
		ItemPedido item3 = new ItemPedido(ped2, p3, 100.00, 1, 800.00);
